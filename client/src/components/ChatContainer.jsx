    ...
    <div className="h-full overflow-scroll  relative backdrop-blur-lg">
      ...
      <div className="flex flex-col h-[calc(100%-200px)] overflow-y-scroll p-3 pb-6">
        ...
        <div className="absolute bottom-0 left-0 right-0  flex items-center gap-3 p-3">
          ...
          onKeyDown={(e) => e.key === "Enter" ? handleSendMessages(e):null} type="text" placeholder="send a message"
          ...
          <img onClick={handleSendMessages} src={assets.send_button} alt="" className="w-7 cursor-pointer"/>
